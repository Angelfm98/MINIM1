...
@Api(value = "/albums", description = "Endpoint to Albums Service")
@Path("/albums")
public class AlbumService {
    ...
    public AlbumService() {
        ...
        if (tm.size()==0) {
            this.tm.addAlbum("Azul", "Georgie Dann");
            this.tm.addAlbum("Rojo", "Luis Fonsi");
            this.tm.addAlbum("Lila", "Metallica");
        }
    }
